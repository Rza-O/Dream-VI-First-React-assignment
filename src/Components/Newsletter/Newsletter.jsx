...
const Newsletter = () => {
    return (
        <div className='w-3/4 h-80 mx-auto bg-banner-shadow bg-center bg-no-repeat bg-cover text-center flex flex-col justify-center space-y-6 relative -bottom-32 z-10 bg-white'>
